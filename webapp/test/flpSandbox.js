		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#toolquestionnaire-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"toolquestionnaire-display": {
								"semanticObject": "toolquestionnaire",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=toolquestionnaire",
									"url": sap.ui.require.toUrl("toolquestionnaire")
								}
							}
						}
					}
